...
<div class="content-wrapper">
    ...
    <div class="decorative-elements">
        ...
        <svg class="list-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="40" y="40" width="120" height="12" rx="6" fill="currentColor" opacity="0.3"/>
            <rect x="40" y="60" width="100" height="12" rx="6" fill="currentColor" opacity="0.3"/>
            <rect x="40" y="80" width="110" height="12" rx="6" fill="currentColor" opacity="0.3"/>
            <rect x="40" y="100" width="90" height="12" rx="6" fill="currentColor" opacity="0.3"/>
            <rect x="40" y="120" width="130" height="12" rx="6" fill="currentColor" opacity="0.3"/>
            <rect x="40" y="140" width="105" height="12" rx="6" fill="currentColor" opacity="0.3"/>
            <rect x="40" y="160" width="95" height="12" rx="6" fill="currentColor" opacity="0.3"/>
            
            <!-- List bullets -->
            <circle cx="25" cy="46" r="4" fill="currentColor" opacity="0.4"/>
            <circle cx="25" cy="66" r="4" fill="currentColor" opacity="0.4"/>
            <circle cx="25" cy="86" r="4" fill="currentColor" opacity="0.4"/>
            <circle cx="25" cy="106" r="4" fill="currentColor" opacity="0.4"/>
            <circle cx="25" cy="126" r="4" fill="currentColor" opacity="0.4"/>
            <circle cx="25" cy="146" r="4" fill="currentColor" opacity="0.4"/>
            <circle cx="25" cy="166" r="4" fill="currentColor" opacity="0.4"/>
            
            <!-- Document outline -->
            <rect x="15" y="25" width="155" height="160" rx="8" fill="none" stroke="currentColor" stroke-width="2" opacity="0.2"/>
        </svg>
    </div>
        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="card card-custom">
                        <div class="card-header text-center py-4">
                            ...
                            <h3 class="card-title mb-0" style="color: white; font-weight: 600;">Sections List</h3>
                            <p class="mb-0" style="color: rgba(255,255,255,0.8);">View sections organized by divisions</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="stats-card">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <small class="text-info">Select one to filter</small>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-header" style="background: linear-gradient(135deg, #17a2b8 0%, #138496 100%); color: white;">
                                <h5 class="mb-0">
                                    ...
                                    Sections for Division: <?php echo htmlspecialchars($selected_division_name); ?>
                                </h5>
                            </div>
                            <div class="card-body card-body-custom p-0">
                                <?php if (empty($sections)): ?>
                                    <div class="no-data">
                                        ...
                                        <p>No sections found for this division.</p>
                                        <a href="section.php" class="btn btn-filter">
                                        ...
                                        <table class="table table-custom mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($sections as $section): ?>
                                                    <tr>
                                                        <td>
                                                            <span class="badge badge-info" style="font-size: 12px; padding: 8px 12px;">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="?delete_section_id=<?php echo htmlspecialchars($section['section_id']); ?>" 
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="no-data">
                            ...
                            <h5>Select a Division</h5>
                            <p>Please select a division from the dropdown above to view its sections.</p>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <div class="row mt-4">
                <div class="col-12 text-center">
                    <a href="section.php" class="btn btn-filter btn-lg px-4 mr-3">
                        <i class="fas fa-plus mr-2"></i>Add New Section
                    </a>
                    <a href="section_Manage.php" class="btn btn-clear btn-lg px-4">

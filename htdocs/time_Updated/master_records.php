                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<tr>
                                ...
                                <td>
                                    <a href='master_view.php?id={$row['employee_ID']}'>
                                        <button type='button' class='btn btn-info btn-sm'>
                                            <i class='fas fa-eye'></i>
                                        </button>
                                    </a>
                                   
                                    <a href='master_records.php?delete_id={$row['employee_ID']}' onclick=\"return confirm('Are you sure you want to delete this employee?');\">

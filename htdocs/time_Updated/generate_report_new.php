...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<th><i class='fas fa-sign-in-alt me-1'></i>Check-In Times & Locations</th>";
        echo "<th><i class='fas fa-sign-out-alt me-1'></i>Check-Out Times & Locations</th>";
        echo "</tr></thead>";
        echo "<tbody>";
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            if ($current_employee_ID !== $previous_employee_ID || $current_date !== $previous_date) {
                if ($previous_employee_ID !== null) {
                    ...
                    echo "<tr>";
                    echo "<td><strong>" . htmlspecialchars($previous_employee_ID) . "</strong></td>";
                    echo "<td>" . htmlspecialchars($previous_employee_name) . "</td>";
                    echo "<td>" . htmlspecialchars($previous_division_name) . "</td>";
                    echo "<td>" . htmlspecialchars($previous_section_name) . "</td>"; 
                    echo "<td><span class='badge bg-primary'>" . $previous_date . "</span></td>";
                    echo "<td>";
                    foreach ($ontime_records as $record) {
                        echo "<span class='status-badge status-in me-1 mb-1 d-inline-block'>" . $record . "</span><br>";
                    }
                    echo "</td>";
                    echo "<td>";
                    foreach ($offtime_records as $record) {
                        echo "<span class='status-badge status-out me-1 mb-1 d-inline-block'>" . $record . "</span><br>";
                    }
                    echo "</td>";
                    echo "</tr>";
                ...
                $previous_section_name = $row['section_name'];

...
if (isset($_GET['download']) && isset($_GET['data'])) {
    $report_data = json_decode(base64_decode($_GET['data']), true);
    
    if ($_GET['download'] === 'pdf') {
        header('Content-Type: application/pdf');
        header('Content-Disposition: attachment; filename="SLPA_Attendance_Report_' . date('Y-m-d') . '.pdf"');
        
        // Simple PDF-like text output (you can enhance with proper PDF library)
        echo "SLPA ATTENDANCE REPORT\n";
        echo "Generated by: $current_user\n";
        echo "Generated on: $current_time\n";
        echo "Period: " . $report_data['from_date'] . " to " . $report_data['to_date'] . "\n";
        echo "Report Type: " . ucfirst($report_data['report_type']) . "\n\n";
        echo "Employee ID\tEmployee Name\tDivision\tSection\tDate\tIn Times\tOut Times\n";
        
        foreach($report_data['records'] as $record) {
            echo $record['employee_ID'] . "\t" . $record['employee_name'] . "\t" . $record['division_name'] . "\t" . $record['section_name'] . "\t" . $record['date_'] . "\t" . $record['ontime'] . "\t" . $record['offtime'] . "\n";
        }
        exit();
    }
    ...
    if ($_GET['download'] === 'excel') {
        ...
        echo "<tr><td colspan='7'>Period: " . $report_data['from_date'] . " to " . $report_data['to_date'] . "</td></tr>";
        ...
        foreach($report_data['records'] as $record) {
            ...
            echo "<td>" . $record['division_name'] . "</td>";
            echo "<td>" . $record['section_name'] . "</td>";
            echo "<td>" . $record['date_'] . "</td>";
            echo "<td>" . $record['ontime'] . "</td>";
            echo "<td>" . $record['offtime'] . "</td>";
            echo "</tr>";
        }
...
<div class="container-fluid py-4">
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['report_type'])) {
        ...
        foreach ($attendance_data as $record) {
            $download_data['records'][] = [
                'employee_ID' => $record['employee_ID'],
                'employee_name' => $record['employee_name'],
                'division_name' => $record['division_name'],
                'section_name' => $record['section_name'],
                'date_' => $record['date_'],
                'ontime' => implode(', ', $record['ontime']),
                'offtime' => implode(', ', $record['offtime'])
            ];
        }

        $encoded_data = base64_encode(json_encode($download_data));
            ...
            <div class="report-container fade-in-up">
                ...
                <div class="text-center mb-4">
                    <div class="btn-group" role="group">
                        <a href="?download=excel&data=<?php echo urlencode($encoded_data); ?>" class="btn btn-download">
                            <i class="fas fa-file-excel me-2"></i>Export to Excel
                        </a>
                        <a href="?download=pdf&data=<?php echo urlencode($encoded_data); ?>" class="btn btn-download">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.printReport = function() {
        ...
        const elementsToHide = document.querySelectorAll('.btn-download, .back-button');
